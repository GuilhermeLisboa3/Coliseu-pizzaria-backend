...
import { AuthenticationError, FieldInUseError, FieldNotFoundError } from '@/domain/error'
...
export abstract class Controller {
  ...
  async handle (httpRequest?: any): Promise<HttpResponse> {
    ...
    try {
      ...
      if (error instanceof FieldInUseError || error instanceof FieldNotFoundError) return badRequest(error)
